...
dataC0       = C0_1 - mean(C0_1);
dataC1       = C1_1 - mean(C1_1);
dataC2       = C2_1 - mean(C2_1);
dataC3       = C3_1 - mean(C3_1);
dataC4       = C4_1 - mean(C4_1);
dataC5       = C5_1 - mean(C5_1);
dataC6       = C6_1 - mean(C6_1);
dataC7       = C7_1 - mean(C7_1);
dataR0       = R0_1 - mean(R0_1);
dataR1       = R1_1 - mean(R1_1);
dataR2       = R2_1 - mean(R2_1);
dataR3       = R3_1 - mean(R3_1);
dataR4       = R4_1 - mean(R4_1);
dataR5       = R5_1 - mean(R5_1);
dataR6       = R6_1 - mean(R6_1);
dataR7       = R7_1 - mean(R7_1);
temp         = size(dataC2);
length_full  = temp(1);
x_fullC0     = dataC0;
x_fullC1     = dataC1;
...
xlabel('All time signal of Column sensor.');
...
%axis([0 2*length_full*dt 0.4*scale 0.6*scale]);
xlabel('All time signal of Row sensor.');
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% run FFT
Nfft        = 2^10;
deltaF      = Fs/Nfft;
...
xlabel("All time signal of column sensor to FFT calculation.");
...
xlabel('All column sensor Fourier transform result.'); 
...
xlabel("All time signal of row sensors to FFT calculation.");
%axis([0 Nfft*1/Fs 0 1*scale]);
%%%%%%%%%%%%%%
% plot fft output
subplot(2,1,2);
...
xlabel('All row sensor Fourier transform result.'); 
%axis([0 Fs 0 Nfft/2*scale]);
%axis([0 Fs 0 25]);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%